...
From outside the main folder you can run the following functionalities as python modules.
...
```
python -m variational-parameter-modeling.code.train
```
...
```
python -m variational-parameter-modeling.code.test_model
```
...
```
python -m variational-parameter-modeling.code.generate_dataset
```